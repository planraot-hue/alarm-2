...
-- ============================================================
--  Chat Bot — ประวัติการสนทนากับผู้ช่วย AI
--  ไม่มี policy update เพราะข้อความที่ส่งไปแล้วไม่มีการแก้
-- ============================================================
...
where schemaname = 'public'
  and tablename in ('events', 'attachments', 'moods', 'habits', 'habit_logs', 'notes', 'chat_messages')
order by tablename;
